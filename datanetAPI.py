...
PARENT_API_PATH = os.path.join(PARENT_DIR, 'datanetAPI.py')

_spec = importlib.util.spec_from_file_location('datanetAPI_parent', PARENT_API_PATH)
if _spec is None or _spec.loader is None:
    raise ImportError(f'Unable to locate parent datanetAPI.py at {PARENT_API_PATH}')
